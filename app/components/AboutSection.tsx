	...
	return (
		<div className="defaultContainer">
			<div className="space-y-6">
				...
				<p className="text-base">
					In my spare time, I enjoy reading and writing about tech and keeping detailed notes on what I learn (in my personal Obsidian vault or in <a href = "https://medium.com/@25benjaminli" target="_blank" rel="noopener noreferrer">public blogs</a>). I also like hiking, rock climbing, and am a bit of a geography nerd (fun fact: I once reached top 100 nationally for competitive GeoGuessr duels). <Link href = "/?section=album" rel="noopener noreferrer">Here</Link> are photos from some of my favorite places so far. Thanks for stopping by!
				</p>
			</div>
		</div>
	);
