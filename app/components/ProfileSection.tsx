	...
	return (
		<div className="w-full py-6 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md px-6 rounded-2xl">
				...
				<div className="flex-center space-x-2 mt-2">
					<svg className="icon-small text-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
						<path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
					</svg>
					<p className="text-muted-small leading-tight">
					...
					<div>
						...
						<div className="flex flex-wrap justify-center gap-4 mt-2">
							<a
								...
								className="social-link flex items-center gap-2 hover:text-blue-600 transition-colors"
							>
