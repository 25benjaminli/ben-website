	...
	return (
		<div className="w-full pb-8 pt-1 md:py-0 bg-white dark:bg-gray-900 px-6 sm:pt-0">
				...
				<div className="space-y-4">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white leading-relaxed">Benjamin Li</h1>
					<h2 className="text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">Computer Science Student at Cornell University</h2>
