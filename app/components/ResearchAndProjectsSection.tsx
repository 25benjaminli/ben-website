...
const projects: Project[] = [
	...
	},
	{
		...
		description: (
			<>
				<p>Led Cornell students to build an improved version of <a href = "https://github.com/karpathy/micrograd" target="_blank" rel="noopener noreferrer">micrograd</a> by Andrej Karpathy, developing a vectorized reverse-mode automatic differentiation engine. Support for more operations, new losses, SGD optimizer, validated on MNIST, and built an interactive visualizer for the computation graph. Presented to Cornell Data Science Club. </p>
				<br />
				<div className="flex justify-center">
	...
	},
	{
		...
		description: (
			<p>Built workloads and model/feature engineering for ML-based system that learns an eviction policy for cache management based on historical key usage patterns. The resulting model outperforms least recently reused (LRU) on synthetic and real-world tasks.</p>
		),
	},
];
