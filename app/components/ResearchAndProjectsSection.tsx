	...
	return (
		<section className="mb-12 px-4 sm:px-0">
			...
			<div className="space-y-4 mb-16 overflow-hidden">
				...
				<p className="break-words-anywhere"><strong>Li, B.</strong> (2023). A Novel Stacked Ensemble Machine Learning Model for Predicting Viral Zoonoses. (Accepted for poster presentation) Association for Computing Machinery (ACM) 2023 Annual Conference on Bioinformatics, Computational Biology, and Health Informatics (ACM-BCB).</p>
			</div>
